...
import com.uxunchina.emall.service.ISysDeptService;
...
public class UserController extends SuperController {
	...
	public String edit(@PathVariable String id, Model model) {
		...
		// List<String> myRolds = Lists.transform(mySysUserRoles, input ->
		// input.getRoleId());
		List<String> myRolds = new ArrayList<String>();
		for (SysUserRole sysUserRole : mySysUserRoles) {
			myRolds.add(sysUserRole.getRoleId());
		}
