package com.uxunchina.emall.controller.system;
...
import com.uxunchina.emall.common.anno.Log;
import com.uxunchina.emall.common.bean.Rest;
import com.uxunchina.emall.common.controller.SuperController;
import com.uxunchina.emall.entity.SysRole;
import com.uxunchina.emall.entity.SysRoleMenu;
import com.uxunchina.emall.entity.SysUser;
import com.uxunchina.emall.entity.SysUserRole;
import com.uxunchina.emall.entity.vo.TreeMenuAllowAccess;
import com.uxunchina.emall.service.ISysMenuService;
import com.uxunchina.emall.service.ISysRoleMenuService;
import com.uxunchina.emall.service.ISysRoleService;
import com.uxunchina.emall.service.ISysUserRoleService;
import com.uxunchina.emall.service.ISysUserService;
...
public class RoleController extends SuperController {
	...
	public String auth(@PathVariable String id, Model model) {
		...
		List<SysRoleMenu> sysRoleMenus = sysRoleMenuService.selectList(new EntityWrapper<SysRoleMenu>()
				.eq("roleId", id));

		// List<String> menuIds = Lists.transform(sysRoleMenus,input ->
		// input.getMenuId());
		...
		List<TreeMenuAllowAccess> treeMenuAllowAccesses = sysMenuService.selectTreeMenuAllowAccessByMenuIdsAndPid(
				menuIds, "0");
	...
	public String getUsers(String roleId, Model model) {
		...
		List<SysUserRole> sysUserRoles = sysUserRoleService.selectList(new EntityWrapper<SysUserRole>().eq("roleId",
				roleId));

		// List<String> userIds = Lists.transform(sysUserRoles,input ->
		// input.getUserId());
