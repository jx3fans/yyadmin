package com.uxunchina.emall.test;
...
public class MysqlGenerator {
	...
	public static void main(String[] args) {
		 ...
		 * dsc.setPassword("root"); dsc.setUrl(
		 * "jdbc:mysql://127.0.0.1:3306/kangarooadmin?characterEncoding=utf8");
		 */
		 ...
		 * this.setMap(map); } }; List<FileOutConfig> focList = new
		 * ArrayList<FileOutConfig>(); focList.add(new
		 * FileOutConfig("/template/entity.java.vm") {
		 * 
		 * @Override public String outputFile(TableInfo tableInfo) { //
		 * 自定义输入文件名称 return "/develop/code/my_" + tableInfo.getEntityName() +
		 * ".java"; } }); cfg.setFileOutConfigList(focList); mpg.setCfg(cfg);
		 */
